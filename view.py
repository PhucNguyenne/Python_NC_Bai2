...
class StudentManagementApp:
    ...
    def setup_add_tab(self):
        ...
        self.reset_button = tk.Button(self.add_tab, text="Reset", command=self.load_all_students)
    ...
    def setup_edit_tab(self):
        ...
        self.reset_button = tk.Button(self.edit_tab, text="Reset", command=self.load_all_students)
    ...
    def setup_delete_tab(self):
        ...
        self.reset_button = tk.Button(self.delete_tab, text="Reset", command=self.load_all_students)
...
def main():
    ...
    logout_callback = lambda: print("Đăng xuất thành công!")  # Thay đổi theo yêu cầu của bạn
